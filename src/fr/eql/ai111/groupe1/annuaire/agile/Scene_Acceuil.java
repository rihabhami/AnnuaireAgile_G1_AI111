...
public class Scene_Acceuil extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        vBox1.setSpacing(10);
        vBox1.getChildren().addAll(modifierButton,ajouterButton,rechercherButton,exporterButton);
        ...
        superAdminMenuItem.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                Scene_loginSuperAdmin scene_loginSuperAdmin= new Scene_loginSuperAdmin();
                try {
                    scene_loginSuperAdmin.start(primaryStage);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
